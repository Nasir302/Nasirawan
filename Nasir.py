#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Nasir Awan
...
CorrectUsername = "Nasirawan"
CorrectPassword = "Nasirawan"
...
def login():
	...
	try:
		...
		print "\033[1;95m      тЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтАвтЧИтАв\033[1;96mNasirawan\033[1;95mтАвтЧИтАвтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧдтЧетЧд"
